...
bool quant_conv2d_create_pipeline(
    ...
    const size_t packed_weights_size = (sizeof(uint8_t) * kernel_size * k_stride + sizeof(uint32_t)) * n_stride;
...
bool quant_conv2d_setup_nhwc(conv_operator_t convolution,
        ...
        uint32_t* output, size_t output_pixel_stride)
    {
        ...
        const size_t output_tile_size = 8;  // mr 
        const size_t tiled_output_size = (output_size + (output_tile_size - 1)) & -output_tile_size;
